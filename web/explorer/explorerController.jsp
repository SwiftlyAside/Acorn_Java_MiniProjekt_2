...
%>
<div class="overflow-auto p-2" style="max-height: 520px">
    <h4><%=target%>
    </h4>
    <%--fullsize--%>
...
<%--                <div class="col view overlay zoom">
        ...
        <div class="col view overlay zoom">
            <a><%=mediaDTOList.get(0).getMedia()%></a>
        </div>
    </div>
    <%--embed player--%>
    <h1>OVERFLOW TEST</h1>
    ...
    <p><iframe frameborder="0" src="//www.youtube.com/embed/NNnpsdjmykU" width="640" height="360" class="note-video-clip"></iframe><br></p>
