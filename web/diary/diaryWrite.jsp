...
<div class='container Dwrite'>
	<form class='form-horizontal frm_Dwrite' id='frm_Dwrite' action='${pageContext.request.contextPath}/index.jsp?open=diary'>
		...
		<div class='row_Dwrite_title'>
			<div class='form-group row'>
				<div class='col'>
					<h4>
						<input class='form-control Dwrite_txt_title' id='Dwrite_txt_title' type='text' name='title' placeholder="제목"/>
					</h4>
				</div>
			</div>
		</div>
